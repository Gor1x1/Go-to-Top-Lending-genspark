...
async function loadData() {
  ...
  // Load vacations and online activity
...
function render() {
  ...
  switch (currentPage) {
    ...
    case 'team_access': pageHtml = renderTeamAccess(); break;
    case 'permissions': pageHtml = renderTeamAccess(); break;
    case 'company_roles': pageHtml = renderTeamAccess(); break;
